...
Output: .xyz-harness/{topicDir}/changes/reviews/spec_review_v1.md`,
  deliverables: [
    ...
    required: true,
    contentChecks: [
      { type: "must_not_match", pattern: "MUST\\s*FIX", message: "spec review contains unresolved MUST FIX items" },
    ],
    },
  ],
  },
...
Output: .xyz-harness/{topicDir}/changes/reviews/plan_review_v1.md`,
  deliverables: [
    ...
    required: true,
    contentChecks: [
      { type: "must_not_match", pattern: "MUST\\s*FIX", message: "plan review contains unresolved MUST FIX items" },
    ],
    },
  ],
  },
...
Output: .xyz-harness/{topicDir}/changes/reviews/e2e_test_plan_review_v1.md`,
  deliverables: [
    ...
    required: true,
    contentChecks: [
      { type: "must_not_match", pattern: "MUST\\s*FIX", message: "e2e test plan review contains unresolved MUST FIX items" },
    ],
    },
  ],
  },
...
Max 2 review rounds. MUST FIX must be resolved before passing.`,
  deliverables: [
    ...
    required: true,
    contentChecks: [
      { type: "must_not_match", pattern: "MUST\\s*FIX", message: "code review contains unresolved MUST FIX items" },
    ],
    },
  ],
  },
...
Max 2 review rounds.`,
  deliverables: [
    ...
    required: true,
    contentChecks: [
      { type: "must_not_match", pattern: "MUST\\s*FIX", message: "test review contains unresolved MUST FIX items" },
    ],
    },
  ],
  },
