...
使用 pi 的 subagent tool 调度，agent 选择 harness-reviewer：
  ...
  prompt: |
    ...
    Your job is ONLY to verify spec compliance — did they build what was asked for?
    Do NOT comment on code quality, style, or design patterns.
    ...
    **Out of scope (do NOT comment on):**
    ...
    - Design patterns or architectural quality
    - Performance optimizations beyond what spec requires
    - Test coverage quality (only check if required tests exist)
